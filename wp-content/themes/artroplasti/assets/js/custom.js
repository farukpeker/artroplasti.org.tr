(function($) {
	...
	(function ($) {
        $(document).ready(function () {
            ...
            $('#cssmenu li.has-sub>a, #cssmenu li.menu-item-has-children>a').on('click', function () {
    ...
    // toggle cross btn js
    $(".toggle-main-wrapper, #sidebar-toggle, #toggle_close").on("click", function () {
